...
| where Timestamp >= datetime(2025-06-09T17:03:59.3104497Z) 
...
2. Searched the DeviceFileEvents for the source of the malicious script "ScheduledUpdate.ps1". Learned that the malicious script was downloaded by Johndoe via Github. The script was downloaded at 2025-06-09T16:30:02.2604543Z and again at 2025-06-09T17:03:33.7503363Z. 
...
3. Checked DeviceEvents for any signs of installation or usage. Based on the logs between "2025-06-09T16:30:30.7973677Z" and "2025-06-09T17:54:23.8772818Z" the ScheduledUpdate.ps1 script was ran multiple times, followed by some obfuscated powershell code, and then appearance of the malicious file "eicar-test-file.com". It is likely that the script that was ran included the obfuscated code which was created to download the malicious file and infect the target computer.
...
AlertEvidence 
| where DeviceName contains "windowsvm-ch25"
| where Timestamp between (datetime(2025-06-09T17:01:55.4918458Z) .. datetime(2025-06-09T17:54:49.5524883Z))
| sort by Timestamp desc 
...
1. **Initial Suspicious Activity Detected**  
   **Timestamp:** 2025-06-09 16:30:02.2604543Z  
...
2. **Malicious Script Execution**  
   **Timestamp:** 2025-06-09 17:03:33.7503363Z  
...
3. **Repeated Script Execution**  
   **Timestamp:** 2025-06-09 17:03:59.3104497Z  
   ...
   **Execution Time:** Multiple runs between 2025-06-09 17:03:59 and 2025-06-09 17:54:17.  
...
5. **Antivirus Blocking of Malicious File**  
   **Timestamp:** 2025-06-09 17:54:49.5524883Z  
   ...
   **Query:** `AlertEvidence | where DeviceName contains "windowsvm-ch25" and Timestamp between (datetime(2025-06-09T17:01:55) .. datetime(2025-06-09T17:54:49)).`  
   **Action Taken:** File execution was prevented, and the threat was neutralized.

6. **Final Investigation and Evidence Collection**  
   **Timestamp:** 2025-06-09 17:54:23.8772818Z  
